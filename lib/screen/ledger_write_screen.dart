...
class _LedgerWriteScreenState extends State<LedgerWriteScreen> {
  ...
  bool validateFieldsCheck() {
    return _titleKey.currentState!.validate() & _priceKey.currentState!.validate();
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      TextFormField(
                        ...
                        style: TextStyle(color: ColorFamily.black, fontSize: 30, fontFamily: FontFamily.mapleStoryLight),
                        // 커서 숨김
                        showCursor: false,
                        // 키보드 타입
                        ...
                        decoration: InputDecoration(
                          hintText: '금액을 입력하세요',
                          hintStyle: TextStyle(color: ColorFamily.gray, fontSize: 20, fontFamily: FontFamily.mapleStoryLight),
                        ...
                        child: ToggleButtons(
                          ...
                          children: [
                            Text(
                                '지출',
                                style: TextStyle(
                                    color: selectTypeState[0] ? ColorFamily.white : ColorFamily.gray,
                                    fontSize: 14,
                            ...
                            Text(
                                '수입',
                                style: TextStyle(
                                    color: selectTypeState[0] ?  ColorFamily.gray : ColorFamily.white,
                                    fontSize: 14,
                                    fontFamily: FontFamily.mapleStoryLight
                                )
                            ),
                    ...
                    children: [
                      Form(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('타이틀', style: TextStyle(color: ColorFamily.black, fontSize: 20, fontFamily: FontFamily.mapleStoryLight)),
