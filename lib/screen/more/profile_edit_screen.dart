...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  String tempProfileImageRoute = "";
  String tempUserNickName = "기본닉네임";
  DateTime tempUserBirth = DateTime.now();
                  ...
                  IconButton(
                      onPressed: () {
                        if (tempUserNickName.isNotEmpty) {
                          FocusScope.of(context).unfocus();
                            provider.setProfileImage(tempProfileImageRoute);
                            provider.setUserNickname(tempUserNickName);
                            provider.setUserBirth(tempUserBirth);
                            provider.setProfileMsg(tempProfileMsg);
                      ...
                      children: [
                        ...
                        const Padding(
                          ...
                          child: Align(
                            ...
                            child:
                            Text(
                                "생년월일", style: TextStyleFamily.normalTextStyle),
                          ),
                        ),
                        const SizedBox(height: 10),
                        SizedBox(
