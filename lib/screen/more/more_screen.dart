        ...
        body: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 10),
              _buildMenuItem(context, '도움말',
                  'lib/assets/icons/message-question.svg', const HelpScreen()),
              const SizedBox(height: 10),
              _buildMenuItem(context, '계정 관리', 'lib/assets/icons/user_edit.svg',
                  const AccountManagementScreen()),
              const SizedBox(height: 10),
              _buildMenuItem(context, '앱 설정', 'lib/assets/icons/setting.svg',
